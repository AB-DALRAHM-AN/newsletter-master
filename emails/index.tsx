...
export const ConfirmSubscription = ({
  ...
  <Html>
    <Head />
    <Preview>CodeWithAbdo-Newsletter Confirmation</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        />
        <Text style={heading}>
          {"Confirm Subscribe to CodeWithAbdo's Newsletter"}
        </Text>
        ...
        <Hr style={hr} />
        <Link href="https://www.youtube.com/@codewithabdo" style={reportLink}>
          DailyWebCoding
        </Link>
      </Container>
    </Body>
...
ConfirmSubscription.PreviewProps = {
  verifyLink: "https://web-dev-newslatter.vercel.app",
